...
def nth_to_last2(head, k, i):
    if head is None:
        return 0
    nth_to_last2(head.next, k, i)
    i.value += 1
    if i.value == k:
        print(head.value)
    return
...
# nth_to_last(ll.head, 4)
# nth_to_last2(ll.head, 4, wrapper)
print(nth_to_last3(ll.head, 3))
